...
LEFT JOIN (
    SELECT 
        ...
        MAX(CASE WHEN de.id = 'dLYeHIgbW5m' AND e.program_stage = 'glKRXmp3I9k' THEN dv.value END) as baseline_school_age_dependents,
        MAX(CASE WHEN de.id = 'GNj9pNISlZX' AND e.program_stage = 'glKRXmp3I9k' THEN dv.value END) as baseline_school_attendance,
        ...
        MAX(CASE WHEN de.id = 'dLYeHIgbW5m' AND e.program_stage = 'Xd5D2XCaPZH' THEN dv.value END) as post_intervention_school_age_dependents,
        MAX(CASE WHEN de.id = 'Pt0rA8uace9' AND e.program_stage = 'Xd5D2XCaPZH' THEN dv.value END) as post_intervention_school_attendance,
